...
const i18n = {
    zh: {
        ...
        birdBackbone: "鸟类主干",
        birdBackboneDesc: "：鸟类依 IOC World Bird List v15.2 展开至科；Neoaves 内部主干优先参照近年广泛使用的系统发育结果。",
        timeScale: "时间标尺",
        timeScaleDesc: "：高阶节点优先参考文献常见的冠群分化时间；末级节点时间为便于可视化整理的近似冠群时间。",
        sourcesTitle: "参考来源",
        imageGen: "图像生成",
        imageGenDesc: "：末级科均以代表物种配图；生成式图像经审核后以内容哈希 WebP 接入。",
        techStack: "技术架构",
    ...
    en: {
        ...
        aboutIntro: "This is an interactive visualization of living Sauropsida, organized at family level for birds and the remaining extant sauropsid lineages.",
        ...
        birdBackboneDesc: ": Birds are expanded to families using IOC World Bird List v15.2; the Neoaves backbone prioritizes widely used recent phylogenetic results.",
        ...
        imageGenDesc: ": Each terminal family uses representative-species imagery, reviewed before it is added as a content-hashed WebP asset.",
